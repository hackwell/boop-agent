...
export const CURATED_TOOLKITS: CuratedToolkit[] = [
  ...
  { slug: "outlook", displayName: "Outlook (Mail + Calendar)", authMode: "managed" },
  { slug: "microsoft_teams", displayName: "Microsoft Teams", authMode: "managed" },
  { slug: "one_drive", displayName: "OneDrive", authMode: "managed" },
  { slug: "share_point", displayName: "SharePoint", authMode: "managed" },
  { slug: "dynamics365", displayName: "Dynamics 365", authMode: "managed" },
